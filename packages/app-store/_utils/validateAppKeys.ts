...
import { getStripeConnectAppKeysParseResult } from "@calcom/app-store/stripepayment/lib/appKeys";
...
export function shouldEnableApp(dirName: string, keys?: Prisma.JsonValue | null): boolean {
  if (dirName === "stripepayment") {
    return getStripeConnectAppKeysParseResult(keys).success;
  }
